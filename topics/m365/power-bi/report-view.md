...
![상호 작용 편집](./img/report-view/edit-interactions-00.png)

즉, 하나의 시각적 개체를 클릭했을 때, 다른 시각적 개체가 어떻게 반응할지 사용자가 지정하는 기능입니다.

#### 필터/강조 표시/없음

시각적 개체를 선택하여 상호 작용 편집 모드로 들어가면, 다른 모든 시각적 개체에 '필터', '강조 표시', '없음' 아이콘이 나타나 원하는 상호 작용 방식을 설정할 수 있습니다.

![필터/강조표시/없음](./img/report-view/edit-interactions-01.png)

- 필터: 선택한 시각적 개체가 다른 비주얼을 필터링함
- 강조: 다른 비주얼에서 해당 데이터만 강조 표시
- 없음: 해당 비주얼은 아무 반응도 하지 않음

### 드릴스루

드릴스루는 내가 클릭한 항목에 맞춰 다른 페이지로 이동하는 기능입니다.

예를 들어 '서울'을 클릭하면, '서울' 데이터만 보여주는 페이지로 이동하는 기능입니다.
