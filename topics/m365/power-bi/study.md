...
8. 데이터가 변경되지 않은 price에서 NA 필터로 제거하고 고정 10진수 타입으로 변경, revenue도 고정 10진수 타입 변경 (문제 있을 시 변환 탭 값 바구기로 빈 값을 0으로 변경)
9. sales 정수로 타입 변경, 문제 있을 시 변환 탭 값바꾸기로 빈 값 0으로 변경
